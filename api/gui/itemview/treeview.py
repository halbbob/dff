...
class TreeView(QTreeView):
    ...
    def clickOnHeader(self,  index):
        self.clearSelection()
        self.changeDirectory(self.model().rootItem.node, None)
    ...
    def getCurrentNode(self):
        ...
        if currentIndexBrowser :
            currentItemBrowser = self.model().getItem(currentIndexBrowser)
            return currentItemBrowser.node
        return False
    ...
    def currentChanged(self,  currentIndex,  previousIndex):
        ...
        self.changeDirectory(itemClicked.node, currentIndex)
    ...
    def mousePressEvent(self, event):
        ...
        #self.changeDirectory(itemClicked.node,  indexClicked)
    ...
    def setIndexAndExpand(self,  child, index):
        ...
        if index <> None and index.isValid():
            if self.currentIndex() <> index :
                ...
                self.changeDirectory(itemClicked.node, index)
