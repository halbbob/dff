...
class VList(object):
    ...
    def pop(self):
        """
        Pop the first element of the map. Once a value has been poped it not
        available anymore.
    ...
    def size(self):
        ...
        Return : the number of elements in the list, and 0 if the list is empty.
        """
    ...
    def swap(self, *args):
        ...
        Switch the content of two lists.

        Params :
                * v : the vlist with which the swap will be done.
        """
    ...
    def begin(self):
        ...
        Return : an iterator to the bein of the list.
        """
