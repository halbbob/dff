...
class Inode : public InodeStructure, public InodeUtils
{
  /*! \class Inode.
    ...
    It is ineritated by \c \b Directory and \c \b RegularFile (which are
    both inodes). <b>'Everything is a file'</b>, so everything has an
  ...
  */
  ...
  bool		is_fucked_up(uint64_t i_nb) const;
