...
bootSector::bootSector(Node* parent)
{
...
// Node*	bootSector::createNode()
// {
//   //XXX TEMPORARY 0 offset
//   //change it to take into account boot sector backup
//   //do not forget reconstruction part
//   try
//     {
//       Node *node = new Node("$bootsector", this->parent, 0, this);
//       node->setFsobj(this->fsobj);
//     }
//   catch(vfsError e)
//     {
//       throw("Fat module: bootsector node creation failed" + e.error);
//     }
// }

//XXX -- Check as much values as possible
void	bootSector::checkBootSectorFields()
{
...
// bool	bootSector::isRelevant(Node *parent)
// {
//   this->parent = parent;
//   try
//     {
...
//       if (this->vfile->read(this->bs, sizeof(bootsector)) == 512)
// 	{
// 	  this->bootsectorToCtx();
// 	  if (this->checkBootSectorFields())
// 	    {
// 	      this->DetermineFatType();
// 	      return true;
// 	    }
// 	  else
// 	    return false;
// 	  //return this->checkBootSectorFields();
// 	}
//       else
// 	//XXX throw read too small
// 	return false;
//     }
//   catch (vfsError e)
//     {
...
// FileMapping*	bootSector::getFileMapping(class Node* node)
// {
// }
